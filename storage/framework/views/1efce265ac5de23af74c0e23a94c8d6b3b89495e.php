...
<head>
    ...
    <title>
        <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            Audi <?php echo e($el->name); ?>
...
<main>
    <section class="car-block">
        <div class="wrapper">
            <div class="car">
                <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <img src="<?php echo e(asset('/public/storage/'.$el->photo)); ?>" class="car-photo" alt="car">
                <div class="car-data">
                    <div class="car-description"><?php echo e($el->description); ?></div>
                    <div class="car-price">Цена от <?php echo e($el->price); ?> рублей</div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<?php /**PATH A:\OSPanel\domains\227-is-19\resources\views/cars/car.blade.php ENDPATH**/ ?>
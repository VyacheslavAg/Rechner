        ...
        <div class="wrapper">
            <div class="header-top">
                ...
                <nav class="header-menu">
                    <ul class="nav-list">
                        <li class="nav-item">
                            <a href="{{ route('car.show', ['model' => 'A3']) }}" class="nav-link">A3</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('car.show', ['model' => 'A4']) }}" class="nav-link">A4</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('car.show', ['model' => 'A5']) }}" class="nav-link">A5</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('car.show', ['model' => 'A6']) }}" class="nav-link">A6</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('car.show', ['model' => 'A7']) }}" class="nav-link">A7</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('car.show', ['model' => 'Q3']) }}" class="nav-link">Q3</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('car.show', ['model' => 'Q5']) }}" class="nav-link">Q5</a>
                        </li>
                    </ul>
                </nav>
            </div>
...
<main>
    ...
    <section class="review-block">
        ...
        <a href="{{ route('review.index') }}"><button class="review-block-btn">Посмотреть все отзывы</button></a>
        <div class="wrapper-form">
            <form action="{{ route('review.create') }}" method="post" class="review-give-feedback-form" enctype="multipart/form-data">
                @csrf
